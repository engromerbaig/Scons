...
const MapComponent = ({ officeCoordinates, accordionData, activeOffice, onPinClick }) => {
  ...
  return (
    ...
    >
      <TileLayer
        url="https://api.mapbox.com/styles/v1/engromerbaig/cmazsu0x100ct01s64wn7dvsd/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZW5ncm9tZXJiYWlnIiwiYSI6ImNtYXpzczRlbjBvbncya3A3NDkxZjE3MDAifQ.aSp6fX0uVkdBt9SQ1VNMTQ"
