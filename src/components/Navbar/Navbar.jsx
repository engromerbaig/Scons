...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 items-end w-full h-16 xl:h-16">
        {/* Left Column - Logo */}
...
<picture>
  ...
  />
        ...
        <div className="flex items-end justify-center h-16 xl:h-16">
          <div className="hidden lg:flex items-center justify-between gap-8 bg-black shadow-md px-12 py-3 rounded-xl min-w-[800px]">
        ...
        <div className="flex items-center justify-end gap-4 h-16 xl:h-16">
