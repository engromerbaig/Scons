  ...
  return (
    <div className={`flex flex-col gap-6 bg-white ${theme.layoutPages.paddingVertical} ${theme.layoutPages.paddingHorizontal}`}>
      ...
      {impacts.map((impact, index) => (
          <div
            key={index}
            className="border-2 xl:border-b-0 w-full xl:max-w-80 border-neon rounded-t-3xl rounded-b-3xl xl:rounded-b-none shadow-xs p-4 xl:p-6 flex flex-col h-48 xl:h-80 "
          >
